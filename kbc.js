     ...
     if (life_line=="yes"){
         ...
         if (c==0){
             ...
             if(ans_list[i]==Ans){
                 ...
                 console.log("incorrect option,you are out of the game")
                 break
             }
             c+=1
             ...
             if (ans_list[i]==Ans){
                 ...
                 console.log("incorrect answer,you are out of the game")
                 break
             }
         }
         ...
         if (ans_list[i]==Ans){
             ...
             console.log("your answer is wrong,you are out of the game")
            break
        }
    }
